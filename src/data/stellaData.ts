...
export const CELESTIAL_EVENTS: CelestialEvent[] = [
  {
    ...
    description: 'El evento astronómico del siglo en la Península Ibérica. La luna cubrirá el 100% del disco solar creando un anillo de diamante de 1m 48s en Castellón.',
  ...
  {
    id: 'evt-perseidas',
    title: 'Lluvia de Estrellas Las Perseidas (Lágrimas de San Lorenzo)',
  ...
  },
  {
    ...
    title: 'Alineación Planetaria Quintuple (Saturno, Júpiter, Marte, Venus, Mercurio)',
    category: 'alineacion',
    categoryLabel: 'Alineación Planetaria',
    date: '28 de Septiembre, 2026',
    peakTime: '05:45h AM (Horizonte Este)',
    description: 'Cinco planetas del sistema solar dispuestos en una arco eclíptico visible de este a oeste.',
    bestVisibilityZone: 'Horizontes despejados hacia el Este y Sur',
    equipmentNeeded: 'Prismáticos 10x50 / Telescopio campo amplio'
  },
  {
    id: 'evt-oposicion-saturno',
    title: 'Oposición de Saturno y Máximo Brillo',
    category: 'visualizacion_planetas',
    categoryLabel: 'Planetas en Oposición',
    date: '8 de Septiembre, 2026',
    peakTime: '00:30h AM',
    description: 'Saturno en su punto más cercano a la Tierra. Anillos visibles con máxima nitidez y sombras tridimensionales.',
    bestVisibilityZone: 'Toda la Península Ibérica',
    equipmentNeeded: 'Telescopio de 90mm o superior con oculares de 100x-200x'
  },
  {
    id: 'evt-geminidas',
    title: 'Lluvia de Estrellas Las Gemínidas',
    category: 'lluvia_estrellas',
    categoryLabel: 'Lluvia de Meteoros',
    date: '13 - 14 de Diciembre, 2026',
    peakTime: '23:00h - 04:00h',
    description: 'La lluvia de meteoros más intensa del año procedente del asteroide (3200) Phaethon, con metales brillantes y trazos lentos.',
    bestVisibilityZone: 'Zonas de montaña Starlight',
    equipmentNeeded: 'Ropa de abrigo extremo y observación a simple vista'
  },
  {
    id: 'evt-superluna',
    title: 'Superluna Llena de la Cosecha',
    category: 'fase_lunar',
    categoryLabel: 'Evento Lunar',
    date: '25 de Octubre, 2026',
    peakTime: '21:15h',
    description: 'La Luna llena en perigeo se verá un 14% más grande y un 30% más brillante de lo habitual.',
    bestVisibilityZone: 'Salida sobre el mar en el horizonte Este',
    equipmentNeeded: 'Cámara fotográfica con teleobjetivo 300mm+'
  }
];
