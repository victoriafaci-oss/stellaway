...
export const STARLIGHT_SPOTS: StarlightSpot[] = [
  ...
  // ══════════════════════════════════════════════════════════════
  // 🇪🇸 ZARAGOZA & ARAGÓN (ZONAS CERTIFICADAS STARLIGHT)
  // ══════════════════════════════════════════════════════════════
  {
    id: 'spot-aranda-zaragoza',
    name: 'Comarca del Aranda - Destino Turístico Starlight',
    ...
    latitude: 41.5642,
    longitude: -1.6841,
    description: 'Comarca oficial de la provincia de Zaragoza acreditada como Destino Turístico Starlight por la Fundación Starlight en julio de 2022. Integra municipios como Illueca, Purujosa, Calcena, Jarque de Moncayo, Tierga, Trasobares, Aranda de Moncayo, Pomer, Oseja y Gotor con una red de miradores estelares protegidos.',
  ...
  {
    id: 'spot-ariza-zaragoza',
    name: 'Ariza - Municipio Starlight (Comunidad de Calatayud)',
    region: 'Zaragoza (Aragón)',
    country: 'España',
    certified: true,
    spotType: 'certified',
    ...
    latitude: 41.3122,
    longitude: -2.0544,
    description: 'Municipio certificado oficialmente como Municipio Starlight en la provincia de Zaragoza (Comarca de Calatayud). Cielos transparentes con alumbrado público respetuoso con la noche y horizonte limpio sobre el valle del río Jalón.',
  ...
  {
    id: 'spot-vicort-zaragoza',
    name: 'Sierra de Vicort - Destino Turístico Starlight',
    region: 'Zaragoza (Aragón)',
    country: 'España',
    certified: true,
    spotType: 'certified',
    bortleClass: 2,
    sqm: 21.85,
    elevationMeters: 1427,
    latitude: 41.3412,
    longitude: -1.5284,
    description: 'Espacio montañoso de la provincia de Zaragoza acreditado oficialmente como Destino Turístico Starlight por la Fundación Starlight en julio de 2025. Abarca municipios de la comarca de Calatayud como Sediles, El Frasno, Mara, Miedes y Villalba Perejil, con cumbres que superan los 1.400 metros de altitud en el Pico del Rayo (1.427 m), ofreciendo cielos limpios de excepcional oscuridad y horizontes despejados hacia el sur.',
  ...
  {
    id: 'spot-moncayo-zaragoza',
    name: 'Parque Natural del Moncayo & Lituénigo Starlight',
    region: 'Zaragoza (Aragón)',
    country: 'España',
    certified: true,
    spotType: 'certified',
    ...
    latitude: 41.8356,
    longitude: -1.7489,
    description: 'Zona de alta calidad estelar en el somontano y cumbre del Moncayo zaragozano. Alberga el Observatorio Astronómico del Moncayo en Lituénigo y puntos de observación con aire alpino seco y seeing óptimo.',
  ...
  {
    id: 'spot-daroca-gallocanta-zaragoza',
    name: 'Campo de Daroca & Laguna de Gallocanta Starlight',
    region: 'Zaragoza (Aragón)',
    country: 'España',
    certified: true,
    spotType: 'certified',
    ...
    latitude: 40.9889,
    longitude: -1.5033,
    description: 'Espacio de astroturismo "Daroca, mina de estrellas" y la gran cuenca endorreica de la Laguna de Gallocanta en la provincia de Zaragoza. Horizontes llanos de 360 grados, aire frío y seco y nula presencia de luces parásitas.',
  ...
  },
  {
    ...
    name: 'Sierra de Albarracín - Destino Starlight',
    region: 'Teruel (Aragón)',
    country: 'España',
    certified: true,
    spotType: 'certified',
    ...
    latitude: 40.4078,
    longitude: -1.4422,
    description: 'Destino Turístico Starlight en los Montes Universales y pinares de rodeno de la Sierra de Albarracín. Cielos de altísima pureza con la Vía Láctea arrojando relieve visible a simple vista.',
  ...
  // ══════════════════════════════════════════════════════════════
  // 🇪🇸 GALICIA (ZONAS CERTIFICADAS STARLIGHT)
  // ══════════════════════════════════════════════════════════════
  {
    id: 'spot-trevinca',
    name: 'Pena Trevinca - A Veiga (Destino Turístico Starlight)',
    ...
    latitude: 42.2478,
    longitude: -7.0258,
    description: 'El primer Destino Turístico Starlight de Galicia (certificado desde 2015). Enclavado en el Macizo de Trevinca con la cumbre más alta de Galicia (Pena Trevinca, 2.127 m), alberga el Centro Astronómico de Trevinca con observatorio y cúpula.',
  ...
  {
    id: 'spot-illas-atlanticas-galicia',
    name: 'Parque Nacional das Illas Atlánticas Starlight (Cíes y Ons)',
    region: 'Pontevedra / A Coruña (Galicia)',
    country: 'España',
    certified: true,
    spotType: 'certified',
    bortleClass: 2,
    ...
    latitude: 42.2275,
    longitude: -8.9056,
    description: 'Destino Turístico Starlight oficial desde 2016. Archipiélagos de las Islas Cíes, Isla de Ons, Sálvora y Cortegada. Nula contaminación lumínica en medio del Océano Atlántico, noches con Vía Láctea reflejada en el mar y seeing excepcional.',
    facilities: ['Camping Starlight en Islas Cíes', 'Rutas nocturnas guiadas con astrónomos', 'Observaciones desde velero', 'Mirador do Alto do Príncipe'],
    subAreas: ['Faro de Cíes (Montefaro)', 'Mirador Alto do Príncipe (Cíes)', 'Mirador de Fedorentos (Isla de Ons)', 'Playa de Rodas'],
    bestSeason: 'Mayo a Octubre',
    imageUrl: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80',
    featured: true
  },
  {
    id: 'spot-muras-galicia',
    name: 'Muras - Destino Turístico Starlight (Serra do Xistral)',
    region: 'Lugo (Galicia)',
    country: 'España',
    certified: true,
    spotType: 'certified',
    ...
    latitude: 43.4689,
    longitude: -7.7214,
    description: 'Destino Turístico Starlight certificado desde 2020 en el norte montañoso de Lugo. Ubicado en la Serra do Xistral, alejado de cualquier resplandor urbano, con valles y turberas de oscuridad casi pura y observación guiada.',
  ...
  {
    id: 'spot-marinas-corunesas-galicia',
    name: 'Mariñas Coruñesas e Terras do Mandeo Starlight',
    ...
    latitude: 43.2189,
    longitude: -8.1978,
    description: 'Reserva de la Biosfera y Destino Turístico Starlight certificado por la Fundación Starlight en 2023. Protege las cuencas fluviales de los ríos Mendo y Mandeo y los montes de Curtis, Sobrado y Aranga con un cielo nocturno limpio y transparente.',
  ...
  },
  {
    ...
    name: 'Costa da Morte - Destino Turístico Starlight',
    region: 'A Coruña (Galicia)',
    country: 'España',
    certified: true,
    spotType: 'certified',
    ...
    latitude: 42.9234,
    longitude: -9.2812,
    description: 'Destino Turístico Starlight en el extremo occidental de Europa continental. Fisterra, Muxía, Carnota y Camariñas con horizonte oeste de oscuridad oceánica infinita sobre el Océano Atlántico.',
  ...
  {
    id: 'spot-lalin-galicia',
    name: 'Lalín - Municipio Starlight (Deza)',
    ...
    latitude: 42.6612,
    longitude: -8.1134,
    description: 'Municipio Starlight en el corazón verde de Galicia. Cuenta con el Observatorio Astronómico de Lalín (en el Castro Tecnológico) y miradores en la Serra do Candán y el Monte Carrio con gran calidad estelar.',
  ...
  },
  {
    ...
    name: 'Ancares Lucenses, Cervantes y Navia Starlight',
    region: 'Lugo (Galicia)',
    country: 'España',
    certified: true,
    spotType: 'certified',
    ...
    latitude: 42.8712,
    longitude: -6.9145,
    description: 'Destino Starlight en la Reserva de la Biosfera de Os Ancares (Lugo). Valles glaciares y pallozas milenarias bajo una cúpula estelar de altísima pureza con la Vía Láctea brillando con sombras naturales.',
  ...
  // ══════════════════════════════════════════════════════════════
  // 🇪🇸 OTRAS GRANDES ZONAS CERTIFICADAS STARLIGHT EN ESPAÑA
  // ══════════════════════════════════════════════════════════════
  {
    id: 'spot-gredos-norte',
    name: 'Sierra de Gredos Norte - Destino Starlight',
    region: 'Ávila (Castilla y León)',
    country: 'España',
    certified: true,
    spotType: 'certified',
    bortleClass: 1,
    ...
    latitude: 40.3512,
    longitude: -5.2341,
    description: 'Destino Turístico Starlight en el Macizo Central de Gredos. Cielos limpios de gran altitud sobre circos glaciares y lagunas alpinas.',
    facilities: ['Red de miradores de Gredos', 'Alojamientos rurales Starlight', 'Talleres astronómicos'],
    bestSeason: 'Verano - Otoño',
    imageUrl: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=800&q=80'
  },
  {
    id: 'spot-muriel-viejo',
    name: 'Muriel Viejo - Destino Starlight',
    region: 'Soria (Castilla y León)',
    country: 'España',
    certified: true,
    spotType: 'certified',
    bortleClass: 1,
  ...
  },
  {
    ...
    name: 'Sierra Sur de Jaén - Reserva Starlight',
  ...
  {
    id: 'spot-aras-olmos',
    name: 'Alto Turia & Aras de los Olmos Starlight',
